...
// "Custom" bank as an extension to Bank 0
#define SOUND_GENERAL_CUSTOM_KIPP_HURTSOUND                           SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x70, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY                                  SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x71, 0xf0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY_GIANT                            SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x72, 0xf0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY_TINY                             SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x73, 0xf0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND                            SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x74, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND_GIANT                      SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x75, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND_TINY                       SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x76, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_KIPP_SPIT                                SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x77, 0xf0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SNAKE_SCREAM                             SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x78, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_KYLE_ANGER                               SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x79, 0xf0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_KYLE_PAIN                                SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7A, 0xf1, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_CHACHING                                 SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7B, 0xf2, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_GET_ME_OUT                               SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7C, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_GREEDY_BASTARD                           SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7D, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_THE_FUCK_YOU_BEEN                        SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7E, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SHITHEAD                                 SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x7F, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_WHO_WANTS_SOME_DOUGH                     SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x80, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_WHAT_ABOUT_ME                            SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x81, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SOMEBODY_GET_ME                          SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x82, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SOME_MONEY_OVER_HERE                     SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x83, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_GET_SOME_OF_THIS                         SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x84, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_EY_OVER_HERE                             SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x85, 0xf3, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_CUSTOM_COIN_CLINK_SINGLE                    SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x80, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_COIN_CLINK_FALL                      SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x81, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
