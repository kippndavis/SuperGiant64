...
#define SOUND_GENERAL_CUSTOM_KIPP_HURTSOUND                           SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x70, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY                                  SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x71, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY_GIANT                            SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x72, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HEY_TINY                             SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x73, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND                            SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x74, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND_GIANT                      SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x75, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_ROY_HURTSOUND_TINY                       SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x76, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_KIPP_SPIT                                SOUND_ARG_LOAD(SOUND_BANK_ACTION,      0x77, 0xff, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
