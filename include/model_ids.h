...
#define MODEL_OPAQUE_STAR                 0xE2        // opaque taken star
...
#define MODEL_MONEY_ANIMATION             0xE4        // money_animation_geo
#define MODEL_CENT_ANIMATION              0xE5        // cent_animation_geo
